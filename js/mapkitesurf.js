...
var markersData = [
   {
      lat: -3.706097,
      lng: -38.593852,
      nome: "Oficina 23 KiteSurf",
      endereco:"Rua 23, 8 ",
      telefone: "(85) 98898-9505" // não colocar virgula no último item de cada maracdor
   },
    {
      lat: -3.736049,
      lng: -38.4550891,
   ...
   },
   {
      lat: -3.8173357,
      lng: -38.4066335,
      nome: "Kite Zone School",
      endereco:"Estrada da Cofeco, 7591",
      telefone: "(85)  98832-3395" // não colocar virgula no último item de cada maracdor
	}
];
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-kitesurf'), mapOptions);
