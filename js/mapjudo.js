...
var markersData = [
   {
      lat: -3.7876648,
      lng: -38.4779781,
      nome: "Academia Profight",
      endereco:"Rua Mário Mamede, 161",
      telefone: "(85) 3025-8432" // não colocar virgula no último item de cada maracdor
   },
   {
      lat: -3.7500339,
      lng: -38.5297041,
      nome: "Infight Dojô Cleber Soares",
      endereco:"Rua Eusébio de Souza, 1571",
      telefone: "(85) 3257-9776" // não colocar virgula no último item de cada maracdor
	},
   {
      lat: -3.7063215,
      lng: -38.5762431,
      nome: "Centro de Treinamento Célio Terceiro",
      endereco:"Rua Jerônimo de Albuquerque, 420",
      telefone: "(85) 98807-3131" // não colocar virgula no último item de cada maracdor
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-judo'), mapOptions);
