...
var markersData = [
   {
      lat: -3.7936803,
      lng: -38.4942043,
      nome: "Atmas - Academia de Tênis de Mesa Aldeota Sul",
      endereco:"Rua Manoel Monteiro, 780",
      telefone: "(85) 3279-8599" // não colocar virgula no último item de cada maracdor
   },
   {
      lat: -3.7303945,
      lng: -38.5352131,
      nome: "Colégio 7 de Setembro",
      endereco:"Avenida Imperador, 1055",
      telefone: "(85) 4006-7777" // não colocar virgula no último item de cada maracdor
  },
   {
      lat: -3.7888522,
      lng: -38.4797605,
      nome: "Colégio Ari de Sá Cavalcante",
      endereco:"Avenida Washington Soares, 3737",
      telefone: "(85) 3477-2000" // não colocar virgula no último item de cada maracdor
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-tenisdemesa'), mapOptions);
