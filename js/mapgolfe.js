...
var markersData = [
   {
      lat: -3.9290113,
      lng: -38.3365291,
      nome: "Aquiraz Riviera",
      endereco:"Rua Um, s/n",
      telefone: "(85) 3391-4655" // não colocar virgula no último item de cada maracdor
   }
];
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-golfe'), mapOptions);
