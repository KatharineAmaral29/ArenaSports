...
var markersData = [
   {
      lat: -3.721773,
      lng: -38.4789726,
      nome: "Veleiro Philosophy",
      endereco:"Av. Beira Mar, 4247 ",
      telefone: "(85) 3263-1406" // não colocar virgula no último item de cada maracdor
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-vela'), mapOptions);
