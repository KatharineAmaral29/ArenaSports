...
var markersData = [
   {
      lat: -3.8039707,
      lng: -38.5296991,
      nome: "Campo de Futebol BNB",
      endereco:"Avenida Heróis do Acre, 99-339",
   ...
   },
   {
      ...
      lng: -38.5191801,
      nome: "Praça da LBA",
      endereco:"Avenida Soriano Albuquerque, s/ nº",
      telefone: "Sem telefone" // não colocar virgula no último item de cada maracdor
	},
	{
      lat: -3.7688874,
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-atletismo'), mapOptions);
