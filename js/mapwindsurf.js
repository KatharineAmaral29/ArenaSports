...
var markersData = [
   {
      ...
      endereco:"Avenida Beira Mar, s/ nº",
      telefone: "(85) 99984-1967"
	  },
   {
      lat: -3.764023,
      lng: -38.440556,
   ...
   },
   {
      ...
      endereco:"Avenida Clóvis Arrais Maia, 3345",
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-windsurf'), mapOptions);
