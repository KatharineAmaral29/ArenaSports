...
var markersData = [
   {
      lat: -3.8051426,
      lng: -38.5242999,
      nome: "Centro de Formação Olímpica do Nordeste",
      endereco:"Av. Alberto Craveiro - Castelão",
      telefone: "Sem telefone" // não colocar virgula no último item de cada maracdor
   },
   {
      lat: -3.7683397,
      lng: -38.5547847,
      nome: "Academia Unisports Ltda",
      endereco:"Rua Professor Teodorico, 520",
      telefone: "(85) 3292-9321" // não colocar virgula no último item de cada maracdor
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-ginastica'), mapOptions);
