...
var markersData = [
   ...
   },
   {
      ...
      endereco:"Av. 13 de Maio, S/N",
      telefone: "Sem telefone" // não colocar virgula no último item de cada maracdor
   },
   {
      lat: -3.7440456,
      lng: -38.5119476,
      nome: "Pista de Skate do Cocó",
      endereco:"Av. Governador Raul Barbosa, 625-641",
      telefone: "Sem telefone" // não colocar virgula no último item de cada maracdor
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-skate'), mapOptions);
