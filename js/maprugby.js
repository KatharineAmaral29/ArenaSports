...
var markersData = [
   {
      ...
      lng: -38.4900983,
      nome: "Campo Do Asa",
      endereco:"R. Procópio Ferreira, 146-276",
   ...
   },
   {
      ...
      endereco:"Rua Marechal Deodoro, 1187",
      telefone: "(85) 3281-3225" // não colocar virgula no último item de cada maracdor
	},
   {
      lat: -3.832145,
      lng: -38.4885634,
      nome: "Estádio Murilão",
      endereco:"Rua Antônio Barros, 309",
      telefone: "Sem telefone" // não colocar virgula no último item de cada maracdor
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-rugby'), mapOptions);
