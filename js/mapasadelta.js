...
var markersData = [
   {
      lat: -3.7601369,
      lng: -38.5441428,
      nome: "Fortaleza Vôo Livre",
      endereco:"Rua Pacatuba, s/nº",
      telefone: "(85) 99979-6027 / (85) 98818-1043"
   }
];
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-asadelta'), mapOptions);
