...
var markersData = [
   {
      ...
      endereco:"Avenida João Pessoa, 3532",
      telefone: "(85) 3023-9040" // não colocar virgula no último item de cada maracdor
   },
   {
      lat: -3.7458445,
      lng: -38.5368042,
      ...
      telefone: "(85) 3281-3225 " // não colocar virgula no último item de cada maracdor
  },
   {
      lat: -3.8072834,
      lng: -38.5224331,
      nome: "Arena Castelão",
      endereco:"Avenida Alberto Craveiro, 2901",
      telefone: "(85) 3304-4501" // não colocar virgula no último item de cada maracdor
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-futebol'), mapOptions);
