...
var markersData = [
   {
      lat: -3.2968242,
      lng: -38.244524,
      nome: "Parque Estadual Marinho da Pedra da Risca do Meio",
      endereco:"Sem endereço",
      telefone: "(85) 98526-6400 " // não colocar virgula no último item de cada maracdor
   },
   {
      lat: -3.7232411,
      lng: -38.4885842,
      nome: "Sal Surfistas",
      endereco:"Av. Beira Mar, 3591-3799",
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-mergulho'), mapOptions);
