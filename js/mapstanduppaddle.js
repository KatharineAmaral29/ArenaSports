...
var markersData = [
   {
      ...
      lng: -38.4921506,
      nome: "Kayakeria",
      endereco:"Avenida Beira Mar, 3211",
      telefone: "(85) 98833-4005" // não colocar virgula no último item de cada maracdor
   },
   {
      lat: -3.780833,
      lng: -38.469656,
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-standuppaddle'), mapOptions);
