...
var markersData = [
   {
      lat: -3.7506093,
      lng: -38.5015025,
      nome: "Clube do Volei Multisport",
   ...
   },
   {
	  lat: -3.7688874,
      lng: -38.4816098,
      nome: "UNIFOR - Universidade de Fortaleza",
      endereco:"Avenida Washington Soares, 1321",
      telefone: "(85) 3477-3000" // não colocar virgula no último item de cada maracdor    
   }
];
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-voleidepraia'), mapOptions);
