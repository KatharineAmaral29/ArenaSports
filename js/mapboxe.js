...
var markersData = [
   {
      lat: -3.743607,
      lng: -38.528663,
      nome: "Escola de Boxe - Robério Pinheiro",
      endereco:"Rua Felino Barroso, 128",
      telefone: "(85) 98601-1114" // não colocar virgula no último item de cada maracdor
   },
   {
      lat: -3.7876648,
      lng: -38.4779781,
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-boxe'), mapOptions);
