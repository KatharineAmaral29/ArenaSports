...
var markersData = [
   {
      lat: -3.7958147,
      lng: -38.4939497,
      nome: "Smart Fit - Oliveira Paiva",
      endereco:"Avenida Oliveira Paiva, 1350",
      telefone: "(85) 3038-6098" // não colocar virgula no último item de cada maracdor
   },
   {
      lat: -3.767983,
      lng: -38.558769,
      nome: "Clube Podium Musculação",
      endereco:"Rua 15 de Novembro, 108",
      telefone: "(85) 3245-2473" // não colocar virgula no último item de cada maracdor
  },
   {
      lat: -3.7958986,
      lng: -38.4844424,
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-musculacao'), mapOptions);
