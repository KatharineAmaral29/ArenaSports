...
var markersData = [
   {
      lat: -3.7506093,
      lng: -38.5015025,
      nome: "Clube do Volei Multsport",
      endereco:"Rua Joaquim Sá, 1140",
      telefone: "(85) 3272-6478" // não colocar virgula no último item de cada maracdor
   },
   {
      lat: -3.7303945,
      lng: -38.5352131,
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-voleibol'), mapOptions);
