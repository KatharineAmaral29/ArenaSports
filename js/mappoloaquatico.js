...
var markersData = [
   {
      lat: -3.7269371,
      lng: -38.4950862,
      nome: "Náutico Atlético Cearense",
      endereco:"Avenida da Abolição, 2727",
      telefone: "(85) 3242-9300" // não colocar virgula no último item de cada maracdor
   }
];
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-poloaquatico'), mapOptions);
