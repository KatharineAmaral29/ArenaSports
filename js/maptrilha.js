...
var markersData = [
   {
      lat: -3.7484399,
      lng: -38.4858798,
      nome: "Parque Ecológico do Cocó",
      endereco:"Avenida Engenheiro Santana Júnior, s/nº ",
      telefone: "(85)  3234-3574" // não colocar virgula no último item de cada maracdor
   }
];
...
function initialize() {
   ...
   map = new google.maps.Map(document.getElementById('map-trilha'), mapOptions);
